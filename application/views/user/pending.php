			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-dark">Pending Applictions</h5>
					</div>
					<!-- Breadcrumb -->
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">Pending Applications</h6>
								</div>
											...
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													<tr>
														...
														<td>61</td>
														<td>2011/04/25</td>
														<td><a href="<?php echo base_url();?>Admin/profile_application_edit"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>Admin/profile_user_view"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a></td>
													</tr>
													<tr>
