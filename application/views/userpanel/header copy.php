                      ...
                      <form action="<?php echo base_url() . 'steps/stripe/pay_loan'; ?>" method="post" id="payLoanForm">
                          ...
                          <div class="btn-group-toggle mb-2" data-toggle="buttons">
                              <label class="btn btn-primary d-block">
                                  <input type="checkbox" class="price-field" value="price_1NMpFTIdYwyIiCqnwUkZ4K0M"> Make A Payment
                              </label>
                          </div>
                          <div class="btn-group-toggle mb-2" data-toggle="buttons">
                              <label class="btn btn-primary d-block">
                                  <input type="checkbox" class="price-field" value="price_1NNDhVIdYwyIiCqnjhaMYt0p"> $34.01/Month For $100
                              </label>
                          </div>

                          <div class="btn-group-toggle mb-2" data-toggle="buttons">
                              <label class="btn btn-primary d-block">
                                  <input type="checkbox" class="price-field" value="price_1NNDjKIdYwyIiCqnm8iAIg4Y"> $71.79/Month For $100
                              </label>
                          </div>

                          <div id="oneTime" class="text-center d-none">
                              <a href="https://buy.stripe.com/9AQbLV4ff4bc1QQdQQ" class="d-block btn btn-primary">Make A Payment</a>
                          </div>

                          <div id="subscription" class="text-center d-none">
                              <a href="https://buy.stripe.com/6oEdU3eTT5fg2UU145" class="d-block btn btn-primary mb-2">$34.01/Month For $100</a>
                              <a href="https://buy.stripe.com/5kA4jtbHHfTU8fe28a" class="d-block btn btn-primary mb-2">$71.79/Month For $250</a>
                              <a href="https://buy.stripe.com/28oaHRbHHfTU2UU6or" class="d-block btn btn-primary mb-2">$134.78/Month For $500</a>
                          </div>
                      </form>
                  </div>
              </div>
