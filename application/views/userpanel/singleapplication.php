                              ...
                              <div class="card-body">
                                 ...
                                 <div id="cardCollpase4" class="collapse pt-3 show">
                                   ...
                                   ?></h4>
                                    ...
                                    <div class="col-md-12">
                                          <div class="login-or">
                                             <hr class="hr-or">
                                             <span class="span-or">DOCUMENTS</span>
                                          </div>
                                       </div>
                                       <div class="col-md-12">
                                          <ul class="list-line">
                                ...
                                <hr>
                                        <div class="col-md-12">
                                          <div class="login-or">
                                             <hr class="hr-or">
                                             <span class="span-or">Pending Documents List</span>
                                          </div>
                                       </div>
                                       <div class="col-md-12">
                                          <ul class="list-line">
                                     ...
                                     <center> <br/>
                                       <form id="doc_admin_upload" action="<?php echo base_url() . 'steps/do_upload_doc' ?>"  enctype="multipart/form-data" method="post">
                                            <input type="hidden" name="app_oid" value="<?php echo $this->uri->segment(3);  ; ?>">
                                            <input type="hidden" name="status" value="<?php echo $status; ?>">
                                            <input type="hidden" name="app_id" value="<?php echo $app_no; ?>">
                                            
                                            <div class="fallback">
                                              <label for="sel1"><b>Upload Document</b></label>&nbsp;&nbsp;
