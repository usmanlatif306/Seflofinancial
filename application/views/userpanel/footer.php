...
<!-- jQuery -->
<script src="<?php echo base_url() . 'assets/userpanel/vendor/jquery.min.js' ?>"></script>
<!-- Bootstrap -->
<script src="<?php echo base_url() . 'assets/userpanel/vendor/popper.min.js' ?>"></script>
<script src="<?php echo base_url() . 'assets/userpanel/vendor/bootstrap.min.js' ?>"></script>

<!-- Perfect Scrollbar -->
<script src="<?php echo base_url() . 'assets/userpanel/vendor/perfect-scrollbar.min.js' ?>"></script>
<!-- DOM Factory -->
<script src="<?php echo base_url() . 'assets/userpanel/vendor/dom-factory.js' ?>"></script>

<!-- MDK -->

<script src="<?php echo base_url() . 'assets/userpanel/vendor/material-design-kit.js' ?>"></script>
<!-- Range Slider -->
<script src="<?php echo base_url() . 'assets/userpanel/vendor/ion.rangeSlider.min.js' ?>"></script>

<script src="<?php echo base_url() . 'assets/userpanel/js/ion-rangeslider.js' ?>"></script>

<!-- App -->

<script src="<?php echo base_url() . 'assets/userpanel/js/toggle-check-all.js' ?>"></script>

<script src="<?php echo base_url() . 'assets/userpanel/js/check-selected-row.js' ?>"></script>

<script src="<?php echo base_url() . 'assets/userpanel/js/dropdown.js' ?>"></script>

<script src="<?php echo base_url() . 'assets/userpanel/js/sidebar-mini.js' ?>"></script>

<script src="<?php echo base_url() . 'assets/userpanel/js/app.js' ?>"></script>

<!-- App Settings (safe to remove) -->

<script src="<?php echo base_url() . 'assets/userpanel/js/app-settings.js' ?>"></script>

<!-- Select2 -->

<script src="<?php base_url() . 'assets/userpanel/vendor/select2/select2.min.js' ?>"></script>

<script src="<?php base_url() . 'assets/userpanel/js/select2.js' ?>"></script>
<script src="<?php base_url() . 'assets/userpanel/js/custom.js' ?>"></script>
<script>
    $('.price-field').on('click', function(e) {
        $('#priceId').val(e.target.value);
        $('#payLoanForm').submit();
    });
</script>
