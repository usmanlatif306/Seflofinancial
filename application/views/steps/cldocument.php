...
<html>
<head>
	<title>Documents Submission | Briskloanz </title>
	 <?php include('top.php'); ?>
	 <style>
	     .error{
	         color:red;
...
<div class="container">
	<form class="msform" name="step4form" method="post" action="<?php echo base_url();?>steps/addClDocument" enctype='multipart/form-data'>
		<fieldset class="">
			<div class="row">
				<div class="col-md-12">
					<div class="doc-step1">
