...
<!--[if gt IE 8]><!-->
<head>
	<title>Business Information | Briskloanz </title>
	 <?php include('top.php'); ?>
	<style>
		.btn-group {
			width: 100%;
...
<form class="msform" id="step3form" name="step3form">
	<fieldset class="">
		...
		<hr>
		<div class="bus-step3 row">
			<h2 class="fs-title">Personal information of Owner(s) </h2>
			<div class="col-md-12">
				<div class="row">
...
//$('form#step3form').on('submit', function(e) {
       ...
       function submit_form(){
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url();?>steps/addClBusiness',
            data: form,
                ...
                if (obj.status == 'success') {
                  ...
                  // $('.success_message').html(obj.message); 
                    setTimeout(function() {
                      ...
                      window.location.href='<?php echo base_url();?>steps/clDocument';
                }, 2000);
